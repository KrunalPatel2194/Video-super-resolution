...
from lib.network import FRVSR, modelnet
...
def testWhileTrain(FLAGS, testno = 0):
    ...
    cmd1 += ["--input_dir_LR", "./LR/city/", # update the testing sequence
...
# The training mode
    ...
    # hard coded save
    filelist = ['main.py','lib/network.py','lib/frvsr.py','lib/dataloader.py','lib/ops.py']
    ...
    if (FLAGS.ratio>0):
        Net = modelnet( rdata.s_inputs, rdata.s_targets, FLAGS )
    else:
